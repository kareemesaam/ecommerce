            ...
            <div class="navbar-collapse collapse" id="navigation">
                ...
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li class="dropdown yamm-fw">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="200">{{$main->name}} <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li>
                                <div class="yamm-content">
                                    <div class="row">
                                        <?php $menus = $MenuCategories->where('parent_id',$main->id) ?> 
                                        @foreach($menus as $menu)
                                        <div class="col-sm-3">
                                            <h5>{{$menu->name}}</h5>
                                            <ul>
                                                @foreach($menu->subcategories as $category)
